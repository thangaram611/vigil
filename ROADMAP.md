...
| **4. Lock feature** | `vigil lock` freezes the active macOS session until a configured key combo. Native Rust helper with an active session CGEventTap; real macOS Lock Screen integration is not part of the default combo-unlock path. | planned — [`future/phase-4-lock-feature.md`](./future/phase-4-lock-feature.md) |
