...
| **3.1. VS Code + GitHub Copilot Chat detection** | In-process JavaScript chat: scoped activity probe under `~/Library/Application Support/Code{,- Insiders}/User/workspaceStorage/*/chatEditingSessions/`. Gated on empirical stability checks. | deferred — see [phase 3 §5.4 / §7](./future/phase-3-desktop-apps.md) |
